...
The SDK key is available on the Split user interface, in your *Admin Settings* page, on the *API keys* tab and *SDK API keys* sub-tab. Choose the `client-side` type.
